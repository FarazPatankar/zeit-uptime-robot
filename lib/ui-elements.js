...
const monitorOverview = (monitors, project, pspLink, configurationId) => {
  ...
  if (project) backButton = `<Box margin-bottom="10px"><Link href="https://zeit.co/dashboard/integrations/${encodeURIComponent(configurationId)}">← Account View</Link></Box>`
